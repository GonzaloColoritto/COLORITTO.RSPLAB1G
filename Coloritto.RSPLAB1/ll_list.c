...
LinkedList* ll_buscarMasAlto(LinkedList* this)
{
    ePais* elemento=NULL;
    LinkedList* listaMasMuertos=NULL;
    int flag=0;
    int cantMuertos;
    ...
    if(this!=NULL)
    {
        listaMasMuertos = ll_newLinkedList();
        if(listaMasMuertos!=NULL)
        {
            ...
            for(int i=0; i<ll_len(this); i++)
            {
                ...
                elemento=ll_get(this,i);
                pais_getMuertos(elemento,&cantMuertos);
                if(flag==0)
                {
                    cantMuertosMayor=cantMuertos;
                    flag=1;
                }
                else if (cantMuertos>cantMuertosMayor)
                {
                    cantMuertosMayor=cantMuertos;
                }

            }
            printf("Cantidad de muertos mas alta %d\n",cantMuertosMayor);

            for(int i=0; i<ll_len(this); i++)
            {
                elemento=ll_get(this,i);
                if(elemento->muertos==cantMuertosMayor)
                {

                    ll_add(listaMasMuertos,elemento);
                }

            }
            printf("Paises que tienen el maximo numero de muertos\n");
            controller_ListPais(listaMasMuertos);
        }

    }
    return listaMasMuertos;
}
